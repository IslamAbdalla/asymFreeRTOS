...
# Memory: memory_buff
MEM_0 := qsys_system_memory_buff
$(MEM_0)_NAME := memory_buff
...
$(MEM_0)_END := 0x00011f9f
$(MEM_0)_SPAN := 0x00001fa0
$(MEM_0)_HIERARCHICAL_PATH := memory_buff
$(MEM_0)_WIDTH := 32
...
.PHONY: memory_buff
memory_buff: check_elf_exists $(MEM_INIT_DIR)/$(MEM_0).hex $(HDL_SIM_DIR)/$(MEM_0).dat $(HDL_SIM_DIR)/$(MEM_0).sym

# Memory: onchip_memory2_0
MEM_1 := qsys_system_onchip_memory2_0
...
$(MEM_1)_END := 0x0000564f
$(MEM_1)_SPAN := 0x00005650
